...
export const WORKFLOW: WorkflowStep[] = [
  ...
  {
    id: 'design-and-stories',
    label: 'Design and stories',
    lane: 'Plan',
    detail: 'Architect designs the solution while BA finalizes user stories from the baseline requirements.',
    environment: 'Repository',
    agents: ['Architect agent', 'Business analyst agent'],
  },
  {
    id: 'developer-handoff',
    label: 'Developer handoff',
    lane: 'Plan',
    detail: 'Start developer work only after design and user stories are finalized.',
    environment: 'Repository',
